...
- [Experience is the Best Teacher: Augmenting LLM Reasoning with Knowledge Learned from the Past](https://dl.acm.org/doi/abs/10.1145/3774904.3792630) - Distills solve-judge-correct trajectories into reusable schemas indexed by core reasoning structures and carries the resulting knowledge repository across tasks to improve future reasoning without weight updates. (WWW 2026)
